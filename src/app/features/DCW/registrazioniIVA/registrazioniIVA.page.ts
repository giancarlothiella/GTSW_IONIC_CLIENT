...
@Component({
  ...
  templateUrl: './registrazioniIVA.page.html',
  styleUrls: ['./registrazioniIVA.page.scss']
})
export class DCW_RegistrazioniIVAComponent implements OnInit, OnDestroy {
  //========= PAGE PARAMS =================
  prjId: string = 'DCW';
  formId: number = 13;
