...
const BACKEND_URL = () => apiUrl() + '/data';
const DB_URL = () => apiUrl() + '/db';
const USER_URL = () => apiUrl() + '/user';
const MAIL_URL = () => apiUrl() + '/mail';
const FILE_URL = () => apiUrl() + '/files';
const SETUP_URL = () => apiUrl() + '/setup';
const TASK_URL = () => apiUrl() + '/task';
const PRJ_URL = () => apiUrl() + '/prj';
